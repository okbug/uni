...
/***/ 14:
/*!*******************************************!*\
  !*** E:/hxws/uni-co/uni-co/utils/base.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var API_HOST = 'https://lc.cxwht.cn'; // 更换为你的网站域名, 需要有 https 协议

var Auth = __webpack_require__(/*! ./auth.js */ 15);
...
{var method = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "GET";var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};var args = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : { token: true };
...
{var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var args = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { token: false };
  return API.request(url, "GET", data, args);
};

API.post = function (url, data)

{var args = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { token: true };
  ...
  return new Promise(function (resolve, reject) {
    if (Auth.check()) {
      ...
      Auth.login().then(function (data) {
        API.post('/wp-json/mp/v1/user/openid', data, {
          token: false }).
        then(function (res) {
...
API.getUserInfo = function () {
  return new Promise(function (resolve, reject) {
    Auth.getUserInfo().then(function (data) {
      API.post('/wp-json/mp/v1/user/login', data, {
        token: false }).
      then(function (res) {
        API.storageUser(res);
        console.log(res);
  ...
  return function () {var _arguments = arguments;
    if (API.getUser()) {
      ...
      return API.getUserInfo().then(function (res) {
        ...
        return fn.apply(self, _arguments);
      }, function (err) {
...
/***/ 15:
/*!*******************************************!*\
  !*** E:/hxws/uni-co/uni-co/utils/auth.js ***!
  \*******************************************/
/*! no static exports found */
...
/***/ 25:
/*!******************************************!*\
  !*** E:/hxws/uni-co/uni-co/utils/api.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var API = __webpack_require__(/*! ./base.js */ 14);
/**
                                 * 获取站点信息
...
var getSiteInfo = function getSiteInfo(data) {
...
var getStickyPosts = function getStickyPosts(data) {
...
var getPostsList = function getPostsList(data) {
...
var getPagesList = function getPagesList(data) {
...
var getPageByID = function getPageByID(id) {
...
var getTagByID = function getTagByID(id) {
...
var getRandPosts = function getRandPosts(data) {
...
var getRelatePosts = function getRelatePosts(data) {
...
var getMostViewsPosts = function getMostViewsPosts(data) {
...
var getMostFavPosts = function getMostFavPosts(data) {
...
var getMostLikePosts = function getMostLikePosts(data) {
...
var getMostCommentPosts = function getMostCommentPosts(data) {
...
var getRecentCommentPosts = function getRecentCommentPosts(data) {
...
var getFavPosts = function getFavPosts(data) {
...
var getLikePosts = function getLikePosts(data) {
...
var getCommentsPosts = function getCommentsPosts(data) {
...
var votePosts = function votePosts(data) {
...
var subscribeMessage = function subscribeMessage(data) {
...
var getCodeImg = function getCodeImg(data) {
...
var getMenuSetting = function getMenuSetting(data) {
...
var indexAdsense = function indexAdsense(data) {
...
var listAdsense = function listAdsense(data) {
...
var detailAdsense = function detailAdsense(data) {
...
var pageAdsense = function pageAdsense(data) {
...
/***/ 4:
/*!****************************************!*\
  !*** E:/hxws/uni-co/uni-co/pages.json ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 7:
/*!*********************************************************!*\
  !*** E:/hxws/uni-co/uni-co/pages.json?{"type":"style"} ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "首页", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/detail/detail": { "enablePullDownRefresh": true, "navigationBarTitleText": "文章详情", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/list/list": { "enablePullDownRefresh": true, "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/category/category": { "enablePullDownRefresh": true, "navigationBarTitleText": "分类栏目", "navigationStyle": "custom", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/query/query": { "navigationBarTitleText": "疫情查询", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/user/user": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/festudy/festudy": { "navigationBarTitleText": "前端每日学习", "usingComponents": { "show-info": "/components/ShowInfo" }, "usingAutoImportComponents": {} }, "pages/tools/tools": { "navigationBarTitleText": "工具", "usingComponents": { "show-info": "/components/ShowInfo" }, "usingAutoImportComponents": {} }, "pages/music/music": { "navigationBarTitleText": "音乐", "usingComponents": {}, "usingAutoImportComponents": {} } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!********************************************************!*\
  !*** E:/hxws/uni-co/uni-co/pages.json?{"type":"stat"} ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
